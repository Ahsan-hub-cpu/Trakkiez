...
<div class="main-content-inner">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4>PKR   <?php echo e($dashboardDatas[0]->TotalAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4>PKR  <?php echo e($dashboardDatas[0]->TotalOrderedAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4>PKR   <?php echo e($dashboardDatas[0]->TotalDeliveredAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4>PKR   <?php echo e($dashboardDatas[0]->TotalCanceledAmount); ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex flex-wrap gap40">
                                            <div>
                                                ...
                                                <div class="flex items-center gap10">
                                                    <h4>PKR <?php echo e($totalAmount); ?></h4>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center gap10">
                                                    <h4>PKR <?php echo e($totalOrderedAmount); ?></h4>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center gap10">
                                                    <h4>PKR <?php echo e($totalDeliveredAmount); ?></h4>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center gap10">
                                                    <h4>PKR <?php echo e($totalCanceledAmount); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">PKR <?php echo e($order->subtotal); ?></td>
                                <td class="text-center">PKR <?php echo e($order->tax); ?></td>
                                <td class="text-center">PKR <?php echo e($order->total); ?></td>
                                
                                <td class="text-center"> <?php if($order->status=='delivered'): ?>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(route('admin.order.items',['order_id'=>$order->id])); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\trakkiez\resources\views/admin/index.blade.php ENDPATH**/ ?>