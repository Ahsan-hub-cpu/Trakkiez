...
<main class="container mt-5">
  <h2 class="section-title"><?php echo e($subcategory->name); ?> Products</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
          <div class="price-input-group">
            <input type="number" id="price-from" class="form-control" placeholder="Min Price" value="<?php echo e(request('price_from')); ?>" min="0">
            <input type="number" id="price-to" class="form-control" placeholder="Max Price" value="<?php echo e(request('price_to')); ?>" min="0">
          </div>
          <small class="text-muted d-block mt-1">Highest price: PKR <?php echo e($maxPrice); ?></small>
        </div>
        -->
        <!-- Sort Filter -->
        <div class="col-md-3 col-sm-6 mb-3">
  ...
  <!-- Clear Filter Button -->
  <?php if(request()->has('color') || request()->has('sort')): ?>
    <div class="text-center mt-3">
      <a href="<?php echo e(route('home.subcategory', ['category_slug' => $category->slug, 'subcategory_id' => $subcategory->id])); ?>" class="btn btn-outline-dark">Clear Filter</a>
    </div>
  <?php endif; ?>
...
<a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>" 
   ...
   data-product-category="<?php echo e($subcategory->name ?? 'unknown category'); ?>"
   aria-label="View details for <?php echo e($product->name); ?>">
    ...
    <!-- Pagination -->
    <?php if(!request()->has('color') && !request()->has('price_from') && !request()->has('price_to') && !request()->has('sort')): ?>
    ...
    <?php endif; ?>
  <?php else: ?>
    <p><?php echo e($noProductsMessage ?? 'No products available in this subcategory.'); ?></p>
  <?php endif; ?>
</main>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\trakkiez\resources\views/subcategory.blade.php ENDPATH**/ ?>