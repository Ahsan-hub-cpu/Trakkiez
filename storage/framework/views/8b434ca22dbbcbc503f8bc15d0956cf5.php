    ...
    <div class="cart-icon-container position-relative d-inline-block">
        ...
        <nav class="navbar navbar-expand-lg d-lg-none">
            <div class="collapse navbar-collapse flex-column bg-body shadow-sm z-3 position-absolute top-100 start-0 w-100" id="mobileNav" style="max-height: 90vh; overflow-y: auto;">
                <div class="container">
                    <form action="<?php echo e(route('home.search')); ?>" method="GET" class="search-field position-relative">
                ...
                <div class="header-tools d-flex align-items-center">
                    <div class="header-tools__item hover-container">
                        ...
                        <div class="search-popup js-hidden-content">
                            <form action="<?php echo e(route('home.search')); ?>" method="GET" class="search-field container">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="header-tools__item hover-container">
                            <a href="<?php echo e(route('login')); ?>" class="header-tools__item" aria-label="Login">
                                <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <use href="#icon_user" />
                                </svg>
                            </a>
                    ...
                    <?php else: ?>
                        <div class="header-tools__item hover-container">
                            <a class="header-tools__item" href="<?php echo e(auth()->user()->utype == 'ADM' ? route('admin.index') : route('user.index')); ?>">
                    ...
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="header-tools__item header-tools__cart" aria-label="Wishlist">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_heart" />
                        </svg>
                        <?php if(Cart::instance('wishlist')->content()->count() > 0): ?>
                            <span class="cart-amount d-block position-absolute js-cart-items-count"><?php echo e(Cart::instance('wishlist')->content()->count()); ?></span>
                        <?php endif; ?>
                    </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('cart.checkout')); ?>" class="btn btn-primary btn-checkout">Go Next to Confirm the Order</a>
    ...
    $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, item) {
                            const url = '<?php echo e(route('shop.product.details', ['product_slug' => '__slug__'])); ?>'.replace('__slug__', item.slug);
                            const imageUrl = '<?php echo e(asset('uploads/products/thumbnails')); ?>/' + item.image;
        ...
        const updateQuantity = debounce(function(button, rowId, newQty) {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { rowId: rowId, quantity: newQty, _token: '<?php echo e(csrf_token()); ?>' },
        ...
        $(document).on('click', '.cart-remove-item', function() {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { rowId: rowId, _token: '<?php echo e(csrf_token()); ?>' },
                success: function(response) {
                    if (response.success) {
                        loadCartContent();
        ...
        $(document).on('click', '#apply-coupon', function() {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { coupon_code: couponCode, _token: '<?php echo e(csrf_token()); ?>' },
                success: function(response) {
                    if (response.success) {
                        loadCartContent();
...
</html><?php /**PATH C:\xampp\htdocs\trakkiez\resources\views/layouts/app.blade.php ENDPATH**/ ?>