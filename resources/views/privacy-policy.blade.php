  ...
  <strong>trakkiez.com</strong> (the “Site”).
    ...
    <ul>
      <li>
        ...
        <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer">http://www.allaboutcookies.org</a>.
      </li>
      <li>
    ...
    <p>
      ...
      including your name, billing address (Soon Available), shipping address, payment information (including credit card numbers [[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]](Soon Available)), 
    ...
    <p>
      ...
      and more generally to improve and optimize our Site (for example, by generating analytics about how our customers browse and 
    ...
    <p>
      ...
      <a href="https://www.shopify.com/legal/privacy" target="_blank" rel="noopener noreferrer">https://www.shopify.com/legal/privacy</a>. 
    ...
    <p>
      ...
      we believe may be of interest to you. For more information about how targeted advertising works, you can visit the Network 
    ...
    <ul>
      <li>
        Facebook: <a href="https://www.facebook.com/settings/?tab=ads" target="_blank" rel="noopener noreferrer">https://www.facebook.com/settings/?tab=ads</a>
      </li>
      <li>
        Google: <a href="https://www.google.com/settings/ads/anonymous" target="_blank" rel="noopener noreferrer">https://www.google.com/settings/ads/anonymous</a>
      </li>
      <li>
        Bing: <a href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads" target="_blank" rel="noopener noreferrer">https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</a>
      </li>
      <li>
    ...
    <p>
      ...
      <a href="http://optout.aboutads.info/" target="_blank" rel="noopener noreferrer">http://optout.aboutads.info/</a>.
    </p>
    ...
    <p>
      ...
      have with you (for example if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above. 
    ...
    <p>
      [[INSERT IF AGE RESTRICTION IS REQUIRED]] The Site is not intended for individuals under the age of [[INSERT AGE]].
    </p>
    ...
    <p>
      ...
      by e-mail at <a href="mailto:help@trakkiezstore.com.pk">help@trakkiezstore.com.pk</a> or by mail using the details provided below , also 
      message us directly on our site using contact-us link.
    </p>
    
    <p>
      Trakkiez Wear<br>
      [Re: Privacy Compliance Officer]<br>
      Trakkiez Wear, Mehar Fiaz Colony AA Block Fatehgarh,<br>
